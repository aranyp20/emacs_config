  ...
  (define-key evil-normal-state-map (kbd "SPC p")
    (lambda ()
      ...
      (let* ((file (buffer-file-name))
        ...
        (message "%s" ref))))
  (define-key evil-normal-state-map (kbd "SPC d") 'diff-hl-show-hunk)
